...
function embed_from_youtube($code) {
	return "<iframe width=\"420\" height=\"315\" src=\"http://www.youtube.com/embed/" . $code . "?rel=0\" frameborder=\"0\" allowfullscreen></iframe>";
}

function thumb_from_youtube($code) {
	return "http://img.youtube.com/vi/" . $code . "/default.jpg";
}


function ngconvert($url) {
	
	return str_replace("http://www.miekemarple.com/nightgallery/", "http://www.nightgallery.ca/", $url);
...
function format_dates( $sql_date1 , $sql_date2 ) {
	...
	//echo "the years are the same";
		//if
		$now = time(); //UNIX TIMESTAMP OF NOW. 
		$format_thisyear_compare = strftime($year, $now);
		if (strftime ($year, $timestamp1) != $format_thisyear_compare ){
			$year2 = $year;
		}
	...
	//echo "the years are different!!!!";
		$year1 = $year;
		$year2 = $year; 
		//this just means they are both getting assigned
		//to be spit out as separate things in the format,
		//not that they are the same.
		
		//aslo, duh, the day and month are not gonna be the same if the years are diff! :
		$month1 = $month;
		$month2 = $month;
		$day1 = $day;
		$day2 = $day;
...
echo "<meta name=\"viewport\" content=\"user-scalable=no, width=device-width\" />
	...
	<link href=\"/styles/iphone.css\" rel=\"stylesheet\" type=\"text/css\" media=\"screen\" />
...
function build_nav( $current_page_name ){
	...
	echo "<div class=\"nav\" id=\"nav\">
			<ul class=\"left\">
				<a href=\"/exhibitions.php\" class=\"" . insertClassIfPage("exhibitions", $current_page_name) . " iphonelink\"><li  class=\"edge\">SHOWS</li></a>
				<a href=\"/exhibitions.php\" class=\"" . insertClassIfPage("exhibitions", $current_page_name) . " desktoplink\"><li  class=\"exhiblink edge\">EXHIBITIONS</li></a>
				<ul id=\"exhibdrop\">
					<div class=\"blacklinebox\">
					<a href=\"/exhibitions.php\" class=\"" . insertClassIfPage("current", $current_page_name) . " desktoplink\"><li>CURRENT</li></a>
					<a href=\"/upcoming.php\" class=\"" . insertClassIfPage("upcoming", $current_page_name) . " desktoplink\"><li>UPCOMING</li></a>
					<a href=\"/previous.php\" class=\"" . insertClassIfPage("previous", $current_page_name) . " desktoplink\"><li>PREVIOUS</li></a>
					</div>
				</ul>
				<a href=\"/artists.php\" class=\"" . insertClassIfPage("artists", $current_page_name) . " desktoplink\"><li>ARTISTS</li></a>
				<a href=\"/news.php\" class=\"" . insertClassIfPage("news", $current_page_name) . " \"><li>NEWS</li></a>
				
			</ul>
			
			<ul class=\"right\">
				<a href=\"/fairs.php\" class=\"" . insertClassIfPage("fairs", $current_page_name) . " desktoplink\"><li>FAIRS</li></a>
				<a href=\"/info.php\" class=\"" . insertClassIfPage("info", $current_page_name) . " \"><li>INFO</li></a>
				<a href=\"/private\" class=\"" . insertClassIfPage("private", $current_page_name) . " desktoplink\"><li class=\"edge\">PRIVATE</li></a>
			</ul>
		</div>";
}
...
echo "<div class=\"footer fine\">
		<p>COPYRIGHT &#169; " . strftime("%G", time()) . "  NIGHT GALLERY All Rights Reserved.</p>
		</div>";
}
