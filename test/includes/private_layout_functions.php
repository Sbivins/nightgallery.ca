...
function build_private_nav( $current_page_name ){
	...
	echo "<a href=\"/nightgallery/private\">
	...
	echo "<div class=\"nav\" id=\"nav\">
			<ul class=\"left\">
				<a href=\"/nightgallery\" class=\"" . insertClassIfPage("nightgallery", $current_page_name) . "\"><li class=\"edge\">NIGHT GALLERY</li></a>
				<a href=\"newwork.php\" class=\"" . insertClassIfPage("newwork", $current_page_name) . "\"><li>NEW WORK</li></a>
			</ul>
			
			<ul class=\"right\">
				<a href=\"/nightgallery/private/\" class=\"" . insertClassIfPage("inventory", $current_page_name) . "\"><li class=\"artistslink\">INVENTORY</li></a>
...
echo 	"<a href=\"add_artwork.php\" class=\"" . insertClassIfPage("addartwork", $current_page_name) . "\">Add Artwork</a>
