	...
	<div class="article">
		...
		<?php
			...
			echo "<div class=\"section\" id=\"lx\">";
				echo "<div>";
					echo "<div class=\"fronteventimage\"  style=\"background-image:url(" . $thisevent['event_pic_url'] . ")\"> &nbsp; </div>";
				echo "</div>";
			echo "</div>";
			...
			echo "</a>";
					...
					echo "<div class=\"fullwidth\" style=\"background-image:url(" . $frontpage['frontpage_image_url'] . ")\">&nbsp;</div>";
		...
		<?php
			...
			$query = "SELECT * FROM ng_events WHERE event_start >= CURRENT_DATE() ORDER BY event_start ASC LIMIT 4";
				...
				while($content = mysql_fetch_array($contentset)){
					...
					echo "<div class=\"calitem\"><a href=\"/nightgallery/event.php?id=" . $content['event_id'] . "&name=" . add_dashes($content['event_title']) . "\">";
	...
	<?php 
		$query = "SELECT * FROM ng_ads ORDER BY ad_position DESC LIMIT 4";
				...
				$counter++;
					...
					echo $ad['ad_id'];
					echo "\" class=\"advert\">
								<p class=\"adimage\" style=\"background-image:url(" . $ad['ad_image_url'] . ")\">
									&nbsp;
									</p>
						...
						echo $event['event_id'];
						echo "\" class=\"advert\">
								<p class=\"adimage\" style=\"background-image:url(" . $event['event_pic_url'] . ")\">
									&nbsp;
									</p>
								<div class=\"adinfo over\">
